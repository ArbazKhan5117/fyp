...
class AdminYourAccount extends Component {
    ...
    renameHandler() {
        ...
        axios.post('http://localhost/fyp-backend/signup/renameProfile.php', fd, headers
        ).then(res => {
    ...
    generateProfileName = () => {
        ...
        axios.post('http://localhost/fyp-backend/signup/giveNewNameToProfile.php', fd, headers
        ).then(res => {
                        ...
                        {this.state.valid === 'yes' ?
                            <div className="present-info">
                                <div className="profile">
                                    <img src={'/uploads/' + this.state.baseProfile}></img>
                                </div>
